...
def test_filescrape():
    ...
    filein_dir = path_input()
    filedb = path_output('db_filescrape.csv')
    fileout_dir = path_output('filescrape')
    fileout_dir_rec = path_output('filescrape_rec')
...
def test_update():
    """ rfigc: test --update """
    filein = path_input()
    filedb = path_output('d_update.csv')
    fileout_dir = path_output('update')
    fileout = path_output('update/added_file.txt')
    fileres1 = path_results('test_rfigc_test_update_append.csv')
    fileres2 = path_results('test_rfigc_test_update_remove.csv')

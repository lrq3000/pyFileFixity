...
- Auto detection of ecc file parameters (and ecc code paramaters). See: "Automatic Recognition and Classification of Forward Error Correcting Codes" by Joseph Frederick Ziegler (2000) (with sourcecode in Matlab here: https://github.com/moreati/ziegler2000) and Zahedi, A., & Mohammad-Khani, G. R. (2012). "Reconstruction of a non-binary block code from an intercepted sequence with application to reed-solomon codes". IEICE TRANSACTIONS on Fundamentals of Electronics, Communications and Computer Sciences, 95(11), 1873-1880.
